...
$res1=mysql_query("select * from data_connection where Stud_Mobile='".$_REQUEST["searchMobile"]."'");
...
<table width="84%" border="0" align="center" >
  <tr>
    <td colspan="2" style="text-align: center"><h1> Student Modify</h1></td>
  </tr>
  <tr>
